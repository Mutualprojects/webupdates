    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 py-24 text-center">
          ...
          >
            Powering industries with AI, IoT, and automation — engineered for
            scale and reliability.
          </motion.p>

          {/* Title icons with white background */}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {filtered.map((item) => {
              ...
              const href = `/products/${slugify(item.__cat)}/${slugify(
                item.label
              )}`;
